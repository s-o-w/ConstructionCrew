...
/// Phase 3 wires MemPalace's MCP server in behind it. Note this is a fallback
/// path only -- the primary way GC/Foremen touch memory is their own hired
/// CLI's native MCP client hitting MemPalace directly, not this interface.
/// </summary>
